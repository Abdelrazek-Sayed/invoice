    ...
    <div class="main-sidemenu">
        <div class="app-sidebar__user clearfix">
            <div class="dropdown user-pro-body">
                <div class="">
                    <img alt="user-img" class="avatar avatar-xl brround" {{-- src="{{ !empty($admin->profile_photo_path) ? url("uploads/$admin->profile_photo_path") : url('uploads/no_image.jpg') }}" --}}
        ...
        <ul class="side-menu">
                ...
                <li class="slide">
                    ...
                    <ul class="slide-menu">
                        @can('اضافة فاتورة')
                            ...
                            <li><a class="slide-item" href="{{ route('invoice.create') }}">اضافة فاتورة جديدة</a></li>
                        @endcan
                        @can('قائمة الفواتير')
                        ...
                        @can('الفواتير المدفوعة')
                            <li><a class="slide-item" href="{{ route('invoice.paid') }}">الفواتير مدفوعة</a></li>
                        @endcan

                        @can('الفواتير الغير مدفوعة')
                            <li><a class="slide-item" href="{{ route('invoice.unpaid') }}">الفواتير الغير مدفوعة</a>
                            </li>
                        @endcan

                        @can('الفواتير المدفوعة جزئيا')
                            <li><a class="slide-item" href="{{ route('invoice.partial') }}">الفواتير المدفوعة
                                    جزئيا</a></li>
                        @endcan
            ...
            @can('التقارير')
                <li class="slide">
                    ...
                    <ul class="slide-menu">
                        @can('تقرير الفواتير')
                            <li><a class="slide-item" href="{{ route('invoice.report') }}">تقارير الفواتير </a></li>
                        @endcan
                        @can('تقرير العملاء')
                ...
                <li class="slide">
                    ...
                    <ul class="slide-menu">
                        ...
                        @can('صلاحيات المستخدمين')
                            <li><a class="slide-item" href="{{ route('roles.index') }}"> صلاحيات
                                    المستخدمين</a>
                            </li>
                        @endcan
