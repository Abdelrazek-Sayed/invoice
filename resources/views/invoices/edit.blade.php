                    ...
                    <form action="{{ route('invoice.update', $invoice->id) }}" method="POST"
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <input class="form-control fc-datepicker" name="due_date" placeholder="YYYY-MM-DD"
                                    type="text" value="{{ $invoice->due_date }}" autocomplete="off" required>
                                @error('due_date')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                            ...
                            <div class="col">
                                ...
                                <select name="section_id" class="form-control SlectBox" onclick="console.log($(this).val())"
                                    ...
                                    @foreach ($sections as $section)
                                        <option value="{{ $section->id }}" @if ($invoice->section_id == $section->id) selected @endif> {{ $section->name }}</option>
                                    @endforeach
                                </select>
                                @error('section_id')
                                    <span class="text-danger">{{ $message }}</span>
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <select name="rate_vat" id="Rate_Vat" class="form-control" onchange="myFunction()" selected>
                                    <!--placeholder-->
